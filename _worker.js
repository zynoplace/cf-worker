...
let urls = [];
let subConverter = ""; //通过环境变量设置，一定要自建，自建 psub 可自行搭建https://github.com/bulianglin/psub
	...
	<body>
		...
		<div class="main-content">
			...
			<div class="image-container">
				<img src="example.jpg" alt="Random Image">
		...
		<script>
			function showTime() {
				...
				document.getElementById("time").innerHTML = '生成时间: 2024-01-25';
			}
			showTime();
		</script>
	</body>
...
async function getUrl(request, targetUrl, 追加UA, userAgentHeader) {
	...
	newHeaders.set("User-Agent", `${追加UA}(${userAgentHeader})`);
